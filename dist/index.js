...
var startServer = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            ...
            app.listen(env_1.PORT || 3000, function () {
                logger_1.default.info("Server is running on port ".concat(env_1.PORT));
                logger_1.default.info("Swagger documentation available at http://localhost:".concat(env_1.PORT, "/api-docs"));
            });
        }
        catch (error) {
